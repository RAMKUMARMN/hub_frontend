...
| Generate an implementation plan | `frontend-planner` | `frontend-planner.agent.md` |
| Review code before merge | `frontend-code-reviewer` | `frontend-code-reviewer.agent.md` |
