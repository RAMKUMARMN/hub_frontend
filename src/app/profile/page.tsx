      ...
      <div className="mx-auto max-w-6xl">
        <Card>
          ...
          <div className="mt-4 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-cixio-dark">
                  {form.fullName}
                </h1>
                <p className="mt-1 text-sm text-gray-500">{form.email}</p>

                <div className="mt-2">
                  <Badge>Joined {joinedDate}</Badge>
                </div>
              </div>
            </div>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[320px_1fr]">
          <aside className="space-y-4">
            <Card>
              <h2 className="text-lg font-semibold text-cixio-dark">
                User info
              </h2>
              ...
              <div className="mt-4 space-y-4 text-sm">
                <div className="flex items-start gap-3">
                  <Mail
                    className="mt-0.5 text-cixio-blue"
                    size={18}
                    aria-hidden="true"
                  />
                  <div>
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Edit the visible account information for this workspace.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-dashed border-cixio-muted/40 bg-cixio-light/40 p-4">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      PNG or JPG, square image preferred.
                    </p>
                  </div>
